...
## Project Structure
    ...
    ├── testshareapplink_de_37844  # Django project configurations
...
1. Clone this repo and `cd testshareapplink_de_37844`
...
2. Clone this repo and `cd testshareapplink_de_37844`
